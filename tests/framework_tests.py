...
class Test_GSSHA_WRF_Framework(TestGridTemplate):
    ...
    def test_rapid_to_gssha(self):
        ...
        self._compare_files_fp(self._generated_file_path('run_200208291800to200208311800'), compare_prj_file)
        # grid_standard.ihg
        ...
        self._compare_files_fp(os.path.join(self.readDirectory, "gssha_project", "grid_standard.cmt"),
    ...
    def test_rapid_to_gssha_date_range(self):
        ...
        self._compare_files_fp(self._generated_file_path('run_200208300000to200208302359'), compare_prj_file)
        # grid_standard.ihg
        compare_igh_file = os.path.join(self.readDirectory, "framework",
    ...
    def test_rapid_to_gssha_min_hotstart(self):
        ...
        self._compare_files_fp(self._generated_file_path('minimal_hotstart_run_200208291800to200208300000'), compare_prj_file)
        # grid_standard.ihg
        compare_igh_file = os.path.join(self.readDirectory, "framework",
    ...
    def _compare_files_fp(self, original, new):
        '''
        Compare the contents of two files with full paths given
        '''
