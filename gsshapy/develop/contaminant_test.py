...
db_url = 'postgresql://swainn:(|water@localhost/gsshapy_contam'
...
sqlalchemy_url = dbt.init_postgresql_db(username='swainn',
                                        password='(|w@ter',
                                        host='localhost',
                                        database='gsshapy_contam')

# GLOBAL PARAMETERS ---------------------------------------------------------------------------------------------------#
read_directory = '/Users/swainn/testing/test_models/ContaminentTransport'
write_directory = '/Users/swainn/testing/test_models/ContaminentTransport/write'
project_file_name = 'contam.prj'



out_file_name = 'contam_out'
new_name = 'contam_out'
spatial = True
srid = ProjectionFile.lookupSpatialReferenceID(read_directory, 'contam_prj.pro')
...
wms_raster = write_session.query(WMSDatasetRaster).get(16)
...
out_path = os.path.join(write_directory, 'constituent_out.kml')
styles = {'radius': 5,
