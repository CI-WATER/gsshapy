...
class GRIDtoGSSHA(object):
    ...
    def xd(self):
        ...
        if self._xd is None:
            ...
            if self.lsm_lat_var not in self._xd.coords:
                self._xd.set_coords(self.lsm_lat_var,
                                    inplace=True)
            if self.lsm_lon_var not in self._xd.coords:
                self._xd.set_coords(self.lsm_lon_var,
                                    inplace=True)
